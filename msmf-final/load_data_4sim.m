%Sgo represent Sgomf
function [Y,Sp,Sd,Sgo,Satc,data] = load_data_4sim(dataset,drugOrTarget)
...
if strcmp(dataset,'gpcr')
    ...
    Sgo = importdata('dataset-new/gpcr_t_sim_GO-MF-Resnik.csv');
...
elseif strcmp(dataset,'enzyme')
    ...
    Sgo = importdata('dataset-new/e_t_sim_GO-MF-Resnik.csv');
...
elseif strcmp(dataset,'ic')
    ...
    Sgo = importdata('dataset-new/ic_t_sim_GO-MF-Resnik.csv');
...
elseif strcmp(dataset,'nr')
    ...
    Sgo = importdata('dataset-new/nr_t_sim_GO-MF-Resnik.csv');
...
elseif strcmp(dataset,'db')
    ...
    Sgo = importdata('dataset-new/db_t_sim_GO-MF-Resnik.csv');
